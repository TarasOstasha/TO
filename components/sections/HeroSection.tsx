        ...
        >
          <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-slate-900/70 p-5 shadow-[0_18px_90px_rgba(15,23,42,0.9)] backdrop-blur-2xl ring-1 ring-white/5">
            <div className="flex items-center justify-between gap-3">
              ...
              <a
                href="https://github.com/tarasostasha"
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full border border-white/20 bg-gradient-to-br from-slate-700 to-slate-950 ring-2 ring-accent/20 transition-opacity hover:opacity-90"
            ...
            <div className="mt-5 grid grid-cols-3 gap-3 text-[11px] text-slate-300">
              <div className="rounded-2xl border border-white/10 bg-white/5 p-3">
                ...
                <p className="mt-1 text-sm font-semibold text-slate-50">+8 yrs</p>
              </div>
              <div className="rounded-2xl border border-white/10 bg-white/5 p-3">
                <p className="text-[10px] uppercase tracking-[0.16em] text-slate-500">
                  Timezone
                </p>
                <p className="mt-1 text-sm font-semibold text-slate-50">[ET]</p>
              </div>
